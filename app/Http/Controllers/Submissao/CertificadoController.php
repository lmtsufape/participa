...
class CertificadoController extends Controller
{
    ...
    public function ajaxDestinatarios(Request $request)
    {
       ...
       if($request->destinatario == Certificado::TIPO_ENUM['apresentador'] || $request->destinatario == Certificado::TIPO_ENUM['expositor']){
        ...
        if($request->destinatario == Certificado::TIPO_ENUM['apresentador'] || $request->destinatario == '6'){
            $data = array(
                'success'   => true,
                'destinatarios'     => $desti,
                'trabalhos' => $trabalhos,
