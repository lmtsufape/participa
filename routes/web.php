...
Route::group(['middleware' => ['auth', 'verified', 'isTemp']], function(){
  ...
  Route::namespace('Inscricao')->group(function () {
    // Controllers Within The "App\Http\Controllers\Admin" Namespace
    Route::get('{id}/inscricoes/nova-inscricao',  'InscricaoController@create')->name('inscricao.create');
    Route::get('inscricoes/atividades-da-promocao','PromocaoController@atividades')->name('promocao.atividades');
    Route::get('inscricoes/checar-cupom',          'CupomDeDescontoController@checar')->name('checar.cupom');
    Route::get('{id}/inscricoes/nova-inscricao/checar','InscricaoController@checarDados')->name('inscricao.checar');

    Route::get('inscricoes/evento-{id}/index',    'InscricaoController@index'   )->name('inscricoes');
    Route::post('inscricoes/criar-promocao',      'PromocaoController@store'    )->name('promocao.store');
    Route::post('inscricoes/destroy/{id}-promocao','PromocaoController@destroy' )->name('promocao.destroy');

    Route::post('inscricoes/criar-cupom',         'CupomDeDescontoController@store')->name('cupom.store');
    Route::get('inscricoes/destroy/{id}-cupom',  'CupomDeDescontoController@destroy')->name('cupom.destroy');
  });
});
