...
<div class="wrapper">
    <div class="sidebar">
        ...
        <ul>
            ...
            <a id="informacoes" href="{{ route('coord.informacoes', ['eventoId' => $evento->id]) }}" style="text-decoration:none;">
                <li>
                    <img src="{{asset('img/icons/info-circle-solid.svg')}}" alt="">
                    <h5>Informações</h5>
                </li>
            </a>
            @can ('isCoordenadorOrCoordenadorDaComissaoOrganizadora', $evento)
            <a id="programacao">
                <li>
                    <img src="{{asset('img/icons/slideshow.svg')}}" alt="">
                    <h5>Programação</h5><img class="arrow" src="{{asset('img/icons/arrow.svg')}}">
                </li>
                <div id="dropdownProgramacao" @if(request()->is('coord/evento/atividade*') || request()->routeIs('coord.arquivos-adicionais') || request()->is('coord/evento/palestrantes*')) style='background-color: gray;display: block;' @else style='background-color: gray' @endif>
                    <a id="cadastrarModalidade" href="{{ route('coord.atividades', ['id' => $evento->id]) }}">
                        <li>
                            <img src="{{asset('img/icons/plus-square-solid.svg')}}" alt="">
                            <h5> Atividades</h5>
                        </li>
                    </a>
                    {{-- <a id="cadastrarModalidade" href="{{ route('inscricoes', ['id' => $evento->id]) }}">
                    <li>
                        <img src="{{asset('img/icons/edit-regular-white.svg')}}" alt="">
                        <h5>Inscrições {{__('Últimos eventos realizados')}}</h5>
                    </li>
            </a> --}}
            ...
            <a id="pdfadicional" href="{{route('coord.arquivos-adicionais', $evento)}}">
                <li>
                    <img src="{{asset('img/icons/file-alt-regular.svg')}}" alt="">
                    <h5>Arquivos adicionais</h5>
                </li>
            </a>

            <a id="palestrantes">
                <li>
                    <img src="{{asset('img/icons/user-tie-solid.svg')}}" alt="">
                    <h5>Palestrantes</h5><img class="arrow" src="{{asset('img/icons/arrow.svg')}}">
                </li>
                <div id="dropdownPalestrantes" style='background-color: #545b62'>
                    <a id="cadastrarPalestrante" href="{{route('coord.palestrantes.create', ['eventoId' => $evento->id])}}" style="background-color: #545b62">
                        <li>
                            <img src="{{asset('img/icons/user-plus-solid.svg')}}" alt="">
                            <h5> Cadastrar palestra</h5>
                        </li>
                    </a>
                    <a id="listarPalestrantes" href="{{route('coord.palestrantes.index', ['eventoId' => $evento->id])}}" style="background-color: #545b62">
                        <li>
                            <img src="{{asset('img/icons/list.svg')}}" alt="">
                            <h5>Listar palestras</h5>
                        </li>
                    </a>
                </div>
            </a>
    ...
    <a id="areas">
        <li>
            <img src="{{asset('img/icons/area.svg')}}" alt="">
            <h5>Áreas</h5><img class="arrow" src="{{asset('img/icons/arrow.svg')}}">
        </li>
    ...
    <a id="modalidades">
        <li>
            <img src="{{asset('img/icons/sitemap-solid.svg')}}" alt="">
            <h5>Modalidades</h5><img class="arrow" src="{{asset('img/icons/arrow.svg')}}">
        </li>
    ...
    <a id="comissao">
        <li>
            <img src="{{asset('img/icons/user-tie-solid.svg')}}" alt="">
            <h5>Comissão Científica</h5><img class="arrow" src="{{asset('img/icons/arrow.svg')}}">
        </li>
        <div id="dropdownComissao" @if(request()->is('coord/evento/comissaoCientifica*')) style='background-color: gray;display: block;' @else style='background-color: gray' @endif>
            ...
            <a id="definirCoordComissao" href="{{ route('coord.definirCoordComissao', ['eventoId' => $evento->id]) }}">
                <li>
                    <img src="{{asset('img/icons/crown-solid.svg')}}" alt="">
                    <h5> Definir Coordenador</h5>
                </li>
            </a>
            @endcan
    ...
    <a id="comissaoOrganizadora">
        <li>
            <img src="{{asset('img/icons/user-tie-solid.svg')}}" alt="">
            <h5>Comissão Organizadora</h5><img class="arrow" src="{{asset('img/icons/arrow.svg')}}">
        </li>
    ...
    <a id="outrasComissoes">
        <li>
            <img src="{{asset('img/icons/user-tie-solid.svg')}}" alt="">
            <h5>Outras comissões</h5><img class="arrow" src="{{asset('img/icons/arrow.svg')}}">
        </li>
        <div id="dropdownOutrasComissoes" @if(request()->is('coord/evento/*/tipocomissao*')) style='background-color: gray;display: block;' @else style='background-color: gray; display: none;' @endif>
            <a id="cadastrarOutraComissao" href=" {{route('coord.tipocomissao.create', $evento)}} ">
                <li>
                    <img src="{{asset('img/icons/user-plus-solid.svg')}}" alt="">
                    <h5 style="font-size: 11px;">Cadastrar comissão</h5>
                </li>
            </a>
            ...
            <a href=" {{route('coord.tipocomissao.show', ['evento' => $evento, 'comissao' => $comissao])}} ">
                <li>
                    <img src="{{asset('img/icons/list.svg')}}" alt="">
                    <h5 style="font-size: 11px;"> {{$comissao->nome}} </h5>
                </li>
            </a>
            @endforeach
        </div>
    ...
    <a id="revisores">
        <li>
            <img src="{{asset('img/icons/glasses-solid.svg')}}" alt="">
            <h5>Avaliadores</h5><img class="arrow" src="{{asset('img/icons/arrow.svg')}}">
        </li>
...
<a id="inscricoes">
    <li>
        <img src="{{asset('img/icons/edit-regular-white.svg')}}" alt="">
        <h5>Inscrições</h5><img class="arrow" src="{{asset('img/icons/arrow.svg')}}">
    </li>
...
<a id="trabalhos">
    <li>
        <img src="{{asset('img/icons/file-alt-regular.svg')}}" alt="">
        <h5>Submissões</h5><img class="arrow" src="{{asset('img/icons/arrow.svg')}}">
    </li>
    ...
    <div id="dropdownTrabalhos" @if(request()->is('coord/evento/trabalhos*')) style='background-color: gray;display: block;' @else style='background-color: gray' @endif>
        <a id="submissoesTrabalhos" href="{{ route('coord.definirSubmissoes', ['eventoId' => $evento->id]) }}">
            <li>
                <img src="{{asset('img/icons/plus-square-solid.svg')}}" alt="">
                <h5>Definir Submissões</h5>
            </li>
        </a>
        <a id="submeterTrabalho">
            <li>
                <img src="{{asset('img/icons/plus-square-solid.svg')}}" alt="">
                <h5>Submeter Trabalho</h5><img class="arrow" src="{{asset('img/icons/arrow.svg')}}">
            </li>
        ...
        <a id="listarTrabalhos">
            <li>
                <img src="{{asset('img/icons/list.svg')}}" alt="">
                <h5>Listar Trabalhos</h5><img class="arrow" src="{{asset('img/icons/arrow.svg')}}">
            </li>
        ...
        <a id="listarAvaliacoes">
            <li>
                <img src="{{asset('img/icons/list.svg')}}" alt="">
                <h5>Listar Avaliações</h5><img class="arrow" src="{{asset('img/icons/arrow.svg')}}">
            </li>
...
<a id="certificados">
    <li>
        <img src="{{asset('img/icons/publish.svg')}}" alt="">
        <h5>Certificados</h5><img class="arrow" src="{{asset('img/icons/arrow.svg')}}">
    </li>
...
<a id="memorias">
    <li>
        <img src="{{asset('img/icons/slideshow.svg')}}" alt="">
        <h5>Memórias</h5><img class="arrow" src="{{asset('img/icons/arrow.svg')}}">
    </li>
...
<a id="eventos">
    <li>
        <img src="{{asset('img/icons/palestrante.svg')}}" alt="">
        <h5>Outras configurações</h5><img class="arrow" src="{{asset('img/icons/arrow.svg')}}">
    </li>
...
<a id="publicar">
    <li>
        <img src="{{ asset('img/icons/publish.svg') }}" alt="">
        <h5>Publicar</h5><img class="arrow" src="{{asset('img/icons/arrow.svg')}}">
    </li>
    ...
    <div id="dropdownPublicar" style="background-color: gray">
        ...
        <a id="publicarEvento" onclick="habilitarEvento()">
            <li>
                <img src="{{asset('img/icons/alto-falante.svg')}}" alt="">
                <h5> Publicar Evento</h5>
            </li>
        </a>

        <a id="desabilitarEventoPublicado" onclick="desabilitarEvento()">
            <li>
                <img src="{{asset('img/icons/alto-falante-nao.svg')}}" alt="">
                <h5> Desfazer publicação</h5>
            </li>
        </a>
    </div>
</a>
