    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <div class="shadow-sm p-4 mb-5 bg-white rounded border-start border-4" style="border-color: #f2a440 !important;">
                <h3 class="mb-4 fw-bold" style="color: #3d93a9; padding-bottom: 10px;">Normas gerais:</h3>
                ...
                <p style="text-align: justify; line-height: 1.6;">
                    Todas as submissões de propostas deverão ser realizadas exclusivamente  pelo site do evento. Para associar-se à SBEE ou regularizar sua situação, acesse o site da SBEE (<a href="https://www.etnobiologia.org/participe" target="_blank">https://www.etnobiologia.org/participe</a>).
                </p>
                <p style="text-align: justify; line-height: 1.6;">
                ...
                <p style="text-align: justify; line-height: 1.6;">
                    Dúvidas podem ser sanadas através do e-mail: <strong>xv.cbee@gmail.com</strong>.
                </p>

                <h3 class="mb-4 fw-bold" style="color: #3d93a9; padding-bottom: 10px;">Normas para Submissão de Atividades e Trabalhos:</h3>
                ...
                <h5 class="mb-4 fw-bold" style="color: #3d93a9; padding-bottom: 10px;">1. Submissão de Trabalhos</h5>
