...
<section class="home-section d-flex align-items-center justify-content-start flex-column">
    ...
    <div class="container-fluid">
        ...
        <div id="carousel-primary" class="carousel slide box-carrousel-primary d-flex align-items-center justify-content-center " data-ride="carousel">
            ...
            <div class="carousel-inner carrousel-container-cards d-flex align-items-center justify-content-start">
                ...
                <div class="carousel-item  @if ($i == 0) active @endif shadow-lg w-100">
                    ...
                    <div class="carrousel-item-box-content d-flex align-items-center justify-content-center flex-column">

                        <div class="titulo-evento carrousel-item-box-titulo d-flex align-items-center justify-content-center">
                        ...
                        <div class="carrousel-item-box-descricao">
                            <div class="box-descricao">
                                ...
                                <a class="link-modal" data-toggle="modal" data-target="#modal{{ $ProximoEvento->id }}">
                                    Saiba mais
                                </a>
                                @else
                                @if($ProximoEvento->is_multilingual && Session::get('locale') === 'en')
                ...
                <div id="listCardSlides" class="list-card-slides">
                    ...
                    <div class="card-slide shadow-lg">
                        <div class="icone-box">
                            ...
                            <img src="{{ asset('storage/' . $eventoPassado->icone_en) }}" alt="imagem evento" width="100%" height="100%">
                            @elseif($eventoPassado->is_multilingual && Session::get('locale') === 'en' && $eventoPassado->fotoEvento_en != null)
                            <img src="{{ asset('storage/' . $eventoPassado->fotoEvento_en) }}" alt="imagem evento" width="100%" height="100%">
                            @elseif ($eventoPassado->icone != null)
                            <img src="{{ asset('storage/' . $eventoPassado->icone) }}" alt="imagem evento" width="100%" height="100%">
                            @elseif($eventoPassado->fotoEvento != null)
                            <img src="{{ asset('storage/' . $eventoPassado->fotoEvento) }}" alt="imagem evento" width="100%" height="100%">
                            @else
                        ...
                        <div class="card-content">
                            ...
                            <div class="card-content-desc">
                                ...
                                <a class="link-modal" data-toggle="modal" data-target="#modal{{ $eventoPassado->id }}">
                                    Saiba mais
                                </a>
                            </div>
                        </div>
