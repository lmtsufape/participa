    ...
    <div class="container mx-auto">
        <div class="d-flex flex-column flex-md-row flex-wrap justify-content-between text-center gap-5 my-3">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-center gap-3">
                <a class="navbar-brand d-inline-block" href="https://www.ufrpe.br/" target="_blank">
                    <img src="{{ asset('/img/MarcasUFRPE-02.png') }}" alt="UFRPE" style="width: 70px; max-width: 100%;">
                </a>

                <div class="text-center text-md-start small list-unstyled" style="max-width: 300px; font-size: 0.8rem">
                    <p class="m-0">&copy;{{ date('Y') }} | UFRPE - Universidade Federal Rural de Pernambuco</p>
                    <address class="m-0 not-italic">Rua Dom Manuel de Medeiros, s/n - Dois Irmãos - Recife - PE</address>
                </div>
            </div>
