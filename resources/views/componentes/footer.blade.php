                    ...
                    <div class="mt-2 mt-md-0 text-center" style="flex: 0 0 auto; width: auto;">
                        ...
                        <div class="d-flex gap-3 justify-content-center align-items-center">
                            ...
                            <a href="mailto:lmts@ufape.edu.br" target="_blank" title="Email">
                                <img src="{{ asset('img/email-icon.png') }}" alt="Email" style="width: 25px; height: 25px;">
                            </a>

                            <!-- Facebook -->
                            <a href="https://www.facebook.com/LMTSUFAPE/" target="_blank" title="Facebook">
                                <img src="{{ asset('img/facebook-icon.png') }}" alt="Facebook" style="width: 25px; height: 25px;">
                            </a>

                            <!-- Instagram -->
                            <a href="https://www.instagram.com/lmts_ufape/" target="_blank" title="Instagram">
                                <img src="{{ asset('img/instagram-icon.png') }}" alt="Instagram" style="width: 25px; height: 25px;">
                            </a>
                        </div>
                    </div>
                </div>
