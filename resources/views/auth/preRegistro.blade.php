                    ...
                    <div class="col-md-12">
                        ...
                        <select id="pais" name="pais" class="form-control @error('pais') is-invalid @enderror">
                            @foreach ($paises as $slug => $pais)
                                <option value="{{ $slug }}" data-iso="{{ $pais['iso'] }}" @if ($slug === $selecionado) selected
                                @endif>
                                    {{ $pais['nome'] }}
                                </option>
                            @endforeach
                    ...
                    <div class="form-group row mb-3">
                        <div class="col-md-6">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="customRadioInline1" name="documento_tipo"
                                    class="custom-control-input" value="cpf" checked>
                                <label class="custom-control-label me-2" for="customRadioInline1">CPF</label>

                                <input type="radio" id="customRadioInline2" name="documento_tipo"
                                    class="custom-control-input" value="cnpj" @error('cnpj') checked @enderror>
                                <label class="custom-control-label me-2" for="customRadioInline2">{{ __('CNPJ') }}</label>

                                <input type="radio" id="customRadioInline3" name="documento_tipo"
                                    class="custom-control-input" value="passaporte" @error('passaporte') checked @enderror>
                            ...
                            <div id="fieldPassaporte" class="mt-2" style="display: none;">
                                <input id="passaporte" type="text"
                                    ...
                                    value="{{ old('passaporte') }}" placeholder="{{ __('Passaporte') }}">
                                @error('passaporte')
                                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                @enderror
                            </div>
