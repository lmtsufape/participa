...
<body style="margin:0;padding:0;background:#f5f7fb;">
    <div style="display:none;max-height:0;overflow:hidden;opacity:0;color:transparent;">
        Carta de Aceite — confirmação de aprovação do trabalho.
    </div>
                ...
                <table role="presentation" class="container" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr>
                        <td align="center" style="padding:28px 28px 10px 28px;">
                            @if (!empty($logoPath))
                                <img src="{{ $message->embed($logoPath) }}" alt="Logo Centro Paulo Freire" width="200"
                                    style="display:block;width:200px;height:auto;border:0;outline:none;text-decoration:none;margin-bottom:15px;">
                            @endif
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="center"
                            ...
                            <div style="color:#6b7280;">
                                © {{ date('Y') }} Centro Paulo Freire • Este é um e-mail automático. Não responda.
                            </div>
                        </td>
                    </tr>
                </table>
