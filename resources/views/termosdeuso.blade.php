        ...
        <ul style="list-style-type: none; padding-left: 0;">
            <li>
                <ul style="list-style-type: none;">
                    ...
                    <li>Bem-vindo aos termos de uso da Plataforma de inscrições e submissão de trabalhos da Universidade Federal Rural de Pernambuco (UFAPE). Estes termos regem o uso do nosso aplicativo web.</li>
                </ul>
            </li>
            <br/>
            <li>
            ...
            <li>
                <ul style="list-style-type: none;">
                    ...
                    <li>4.1 - Os dados que compõe o sistema são de uso da Universidade Federal Rural de Pernambuco e das pró-reitorias que a compõem.</li>
            ...
            <li>
                <ul style="list-style-type: none;">
                    ...
                    <li>A Universidade Federal Rural de Pernambuco poderá revisar e atualizar estes termos de uso e de privacidade a qualquer momento, ficando o usuário vinculado à versão atualizada desses termos.</li>
                </ul>
            </li>
            <br/>
            <li>
