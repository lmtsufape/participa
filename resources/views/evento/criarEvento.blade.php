                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            <div class="custom-control custom-radio custom-control-inline col-form-label">
                                ...
                                <input type="radio" id="online" name="formato" value="online" class="custom-control-input" @checked(old('formato', 'online') == 'online')>
                                <label class="custom-control-label me-2" for="online">{{ __('Online') }}</label>

                                <input type="radio" id="presencial" name="formato" value="presencial" class="custom-control-input" @checked(old('formato') == 'presencial')>
                                <label class="custom-control-label me-2" for="presencial">{{__('Presencial')}}</label>

                                <input type="radio" id="hibrido" name="formato" value="hibrido" class="custom-control-input" @checked(old('formato') == 'hibrido')>
