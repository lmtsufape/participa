                                        ...
                                        <div class="card card-body mb-4">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" name="autor[email]" id="autor_email" class="form-control @error('autor.email') is-invalid @enderror" value="{{ old('autor.email') }}" @unless(auth()->user()->administrador()->exists()) readonly value="{{auth()->user()->email}}"@endunless>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" name="autor[nome]" id="autor_nome" class="form-control @error('autor.nome') is-invalid @enderror" value="{{ old('autor.nome') }}" @unless(auth()->user()->administrador()->exists()) readonly value="{{auth()->user()->name}}"@endunless>
